...
# def parse_pugan_args_multiscale():
#     parser = argparse.ArgumentParser(prog="pugan_multiscale")
...
#                        help='warm up end epoch of cosine scheduler')
#     parser.add_argument('--lr_decay_step', default=20, type=int, 
#                        help='learning rate decay step size')
#     parser.add_argument('--gamma', default=0.5, type=float, 
#                        help='gamma for scheduler_steplr')
    
#     # dataset
#     parser.add_argument('--dataset', default='pugan', type=str, help='pu1k or pugan')
#     parser.add_argument('--h5_file_path', 
#                        default="./data/PU-GAN/train/PUGAN_poisson_256_poisson_1024.h5", 
#                        type=str, help='the path of train dataset')
#     parser.add_argument('--num_points', default=256, type=int, 
#                        help='the points number of each input patch')
#     parser.add_argument('--skip_rate', default=1, type=int, help='used for dataset')
...
#                        help='the number of update iterations')
#     parser.add_argument('--test_step_size', default=50, type=float, 
#                        help='predefined test step size')
#     parser.add_argument('--test_input_path', 
#                        default='./data/PU-GAN/test_pointcloud/input_2048_4X/input_2048/', 
#                        type=str, help='the test input data path')
#     parser.add_argument('--ckpt_path', 
#                        default='./pretrained_model/pugan_multiscale/ckpt/ckpt-epoch-60.pth', 
#                        type=str, help='the pretrained model path')
#     parser.add_argument('--patch_rate', default=3, type=int, 
#                        help='used for patch generation')
#     parser.add_argument('--save_dir', default='pcd', type=str, 
#                        help='save upsampled point cloud')
#     parser.add_argument('--double_4X', default=False, type=str2bool, 
#                        help='conduct 4X twice to get 16X')
...
def parse_pugan_args():
    ...
    # lr scheduler
    parser.add_argument('--scheduler_type', default='cosine', type=str, help='step or cosine')
    parser.add_argument('--warm_up_end', default=250, type=int, help='warm up end epoch')
    parser.add_argument('--lr_decay_step', default=20, type=int, help='learning rate decay step')
    parser.add_argument('--gamma', default=0.5, type=float, help='gamma for scheduler_steplr')
    
    # dataset
    parser.add_argument('--dataset', default='pugan', type=str, help='pu1k or pugan')
    parser.add_argument('--h5_file_path', default="./data/PU-GAN/train/PUGAN_poisson_256_poisson_1024.h5", type=str)
    parser.add_argument('--num_points', default=256, type=int)
    ...
    parser.add_argument('--ckpt_path', default='./pretrained_model/pugan/ckpt/ckpt-epoch-60.pth', type=str)
    parser.add_argument('--patch_rate', default=3, type=int)
    parser.add_argument('--save_dir', default='pcd', type=str)
    parser.add_argument('--double_4X', default=False, type=str2bool)
    ...
    parser.add_argument('--use_normal_estimation', default=False, type=str2bool)
    parser.add_argument('--normal_loss_weight', default=0.1, type=float)
    parser.add_argument('--normal_estimation_method', default='pca', type=str)
    parser.add_argument('--k_normal_estimation', default=20, type=int)
